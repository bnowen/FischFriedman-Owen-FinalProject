...
oct23_region <- as_tibble(oct23$interest_by_dma)
oct25_region <- as_tibble(oct25$interest_by_dma)
oct27_region <- as_tibble(oct27$interest_by_dma)
oct29_region <- as_tibble(oct29$interest_by_dma)
oct31_region <- as_tibble(oct31$interest_by_dma)
nov2_region <- as_tibble(nov2$interest_by_dma)
nov4_region <- as_tibble(nov4$interest_by_dma)
nov6_region <- as_tibble(nov6$interest_by_dma)
nov8_region <- as_tibble(nov8$interest_by_dma)
nov10_region <- as_tibble(nov10$interest_by_dma)
nov12_region <- as_tibble(nov12$interest_by_dma)
nov14_region <- as_tibble(nov14$interest_by_dma)
nov16_region <- as_tibble(nov16$interest_by_dma)
nov18_region <- as_tibble(nov18$interest_by_dma)
