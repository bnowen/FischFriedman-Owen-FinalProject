...
#Option 1 - Diverging Dot Plot in Ggplot?
```{R}
library(ggplot2)
theme_set(theme_bw())

# Plot
ggplot(byregion, aes(x=location, y=hits, label=hits)) + 
  geom_point(stat='identity', aes(col=keyword), size=2)  +
  #scale_color_manual(name="Mileage", 
   #                  labels = c("Above Average", "Below Average"), 
    #                 values = c("above"="#00ba38", "below"="#f8766d")) + 
  geom_text(color="white", size=2) +
  labs(title="Diverging Dot Plot", 
       subtitle="Keyword Searches by State") + 
  ylim(-2.5, 2.5) +
  coord_flip()
```

#FOR MOLLY
#Option 2 - PLotly? Seems like our best shot.
...
- Date variable needs to be set to DATETIME format or Plotly cannot format it correctly
...
forplot <- forplot %>% 
     mutate(date = recode(date, '2024-10-23 2024-10-24' = '10/23', '2024-10-25 2024-10-26' = '10/25', '2024-10-27 2024-10-28' = '10/27', '2024-10-29 2024-10-30' = '10/29', '2024-10-31 2024-11-01' = '10/31', '2024-11-02 2024-11-03' = '11/2', '2024-11-04 2024-11-05' = '11/4', '2024-11-06 2024-11-07' = '11/6', '2024-11-08 2024-11-09' = '11/8', '2024-11-10 2024-11-11' = '11/10', '2024-11-12 2024-11-13' = '11/12', '2024-11-14 2024-11-15' = '11/14', '2024-11-16 2024-11-17' = '11/16', '2024-11-18 2024-11-19' = '11/18'))
...
fig <- fig %>%
  animation_opts( #higher value makes animation slower
    10000, easing = "cubic-in", redraw = FALSE 
  )
fig
```
